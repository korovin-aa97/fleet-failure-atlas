...
Last exercised for v0.1.0 on 2026-08-29.
...
- [x] All v0.1.0 incident-like claims are labelled hypothetical.
...
- [x] CI covers Python 3.11, 3.12, and 3.13.
...
- [x] CI and Pages workflows use current official action major versions.
...
5. Publish immutable tag `v0.1.0` and GitHub Release notes.
